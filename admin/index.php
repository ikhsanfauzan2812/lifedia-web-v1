                        ...
                        <div class="card mb-4">
                            ...
                            <?php
                                        ...
                                        if ($result->num_rows > 0){
                                            ...
                                            echo "<thead><tr><th>Nama Lengkap</th><th>Email</th><th>Nomor Telepon</th><th>Tanggal Lahir</th><th>Jenis Kelamin</th><th>Tinggi</th><th>Berat Badan</th><th>Indeks Masa Tubuh</th></tr></thead>";
                                            while ($row = $result->fetch_assoc()) {
                                                echo "<tr><td>".$row["NamaLengkap"]."</td><td>".$row["Email"]."</td><td>".$row["NomorTelepon"]."</td><td>".$row["TanggalLahir"]."</td><td>".$row["JenisKelamin"]."</td><td>".$row["Tinggi"]."</td><td>".$row["BeratBadan"]."</td><td>".$row["IndeksMasaTubuh"]."</td>";
                                            }
                                            echo "</table>";
                                        }
